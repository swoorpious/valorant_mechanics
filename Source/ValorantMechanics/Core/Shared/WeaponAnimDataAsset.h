...
#pragma region ANIMATIONS
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Pose",
        meta = (DisplayName= "Alternate Idle Pose"))
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Alternate",
        meta = (DisplayName= "Alternate Attack", EditCondition = "hasAltAttack", EditConditionHides))
    TObjectPtr<UAnimMontage> altAttack = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Alternate",
        meta = (DisplayName= "Alternate Idle Animation", EditCondition = "hasAltAttack", EditConditionHides))
    TObjectPtr<UAnimSequence> altIdleAnimation = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Alternate",
        meta = (DisplayName= "Alternate Jump", EditCondition = "hasAltAttack", EditConditionHides))
    TObjectPtr<UAnimSequence> altJump = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Alternate",
        meta = (DisplayName= "Alternate Run", EditCondition = "hasAltAttack", EditConditionHides))
    TObjectPtr<UAnimSequence> altRun = nullptr;

    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations|Alternate",
        meta = (DisplayName= "Alternate Walk", EditCondition = "hasAltAttack", EditConditionHides))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations",
        meta = (DisplayName = "Attack Animations"))
    TArray<TObjectPtr<UAnimMontage>> attackArray; // Attack1, Attack2, Attack3, Attack4
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Character|Animations",
        meta = (EditCondition = "canReload", EditConditionHides))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon|Animations",
        meta = (EditCondition="hasWeaponAnimations", EditConditionHides))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon|Animations",
        meta = (EditCondition="hasWeaponAnimations && canReload", EditConditionHides))
...
#pragma region SOUNDS
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon|Sounds",
        meta = (DisplayName = "Attack Sound Effects"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon|Sounds",
        meta = (DisplayName = "Reload Sound Effect", EditCondition= "canReload", EditConditionHides))
